/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e6bd459c9e51964eb410daa45e47070)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		STOCK_MEDIA_URL: "https://stock-media.solamp.workers.dev";
		RENDER_SERVICE_URL: "https://render-service.solamp.workers.dev";
		STORAGE: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
		VIDEO_WORKFLOW: Workflow<Parameters<import("./dist/_worker").VideoProductionWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TEXT_GEN_URL" | "AUDIO_GEN_URL" | "STOCK_MEDIA_URL" | "RENDER_SERVICE_URL">> {}
}
